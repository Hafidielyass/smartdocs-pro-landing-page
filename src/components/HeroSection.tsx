        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="max-w-xl animate-fade-up">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground mb-8 leading-relaxed">
              Seamlessly integrated with <strong className="text-primary">mlean mPS</strong>, our software streamlines your entire document workflow—from creation to compliance—
              <strong className="text-foreground"> reducing manual work</strong> and{" "}
              <strong className="text-foreground">eliminating version confusion</strong>.
            </p>
            ...
            <div className="mt-8 flex items-center gap-4">
              ...
              <div className="text-sm">
                ...
                <span className="text-muted-foreground"> companies trust DocuFlow</span>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-elevated border border-border/50 bg-card">
                <img
                  ...
                  alt="DocuFlow Dashboard - Document management interface showing folder structure, document grid view, and collaboration features"
              ...
              <div className="absolute -bottom-6 -left-6 bg-card rounded-xl shadow-card border border-border/50 p-4 animate-float">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-lg bg-chart-2/20 flex items-center justify-center">
                    <svg className="w-6 h-6 text-chart-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      <polyline points="20,6 9,17 4,12" />
                    </svg>
                  </div>
                  <div>
                    <p className="font-semibold text-foreground">98% Compliance</p>
                    <p className="text-sm text-muted-foreground">Audit-ready documents</p>
                  </div>
                </div>
              </div>
